    ...
    try {
      ...
      const enabledGateways = {
        stripe: {
          ...
          feePercentage: parseFloat(process.env.STRIPE_FEE_PERCENTAGE || '0'),
          fixedFee: parseFloat(process.env.STRIPE_FIXED_FEE || '0')
        },
        paypal: {
          enabled: process.env.PAYPAL_ENABLED === 'true',
          displayName: 'PayPal',
          description: 'PayPal payments',
          feePercentage: parseFloat(process.env.PAYPAL_FEE_PERCENTAGE || '0'),
          fixedFee: parseFloat(process.env.PAYPAL_FIXED_FEE || '0')
        },
        razorpay: {
